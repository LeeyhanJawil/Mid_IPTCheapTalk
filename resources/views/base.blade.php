...
<body>
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            <a class="navbar-brand text-black" href="/"><i class="fas fa-headset"></i> CheapTalk</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    @if(Auth::check())
                        ...
                        <li class="nav-item">
                            <a class="nav-link box text-black" href="/authors"><i class="fas fa-users"></i> Users</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link box text-black" href="/logout">Logout</a>
                        </li>
                    @else
                        <li><a class=" nav-link box text-black " href="/login">Login</a></li>
                        <li><a class=" nav-link box text-black" href="/register">Register</a></li>
                    @endif
                </ul>
              </div>
        </div>
